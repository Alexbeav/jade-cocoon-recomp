...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Jade Cocoon: Story of the Tamamayu",
    .project_root_env = "JADE_COCOON_STORY_OF_THE_TAMAMAYU_PROJECT_ROOT",
    .build_dir_env = "JADE_COCOON_STORY_OF_THE_TAMAMAYU_BUILD_DIR",
    .force_setup_env = "JADE_COCOON_STORY_OF_THE_TAMAMAYU_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.54_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Jade_Cocoon_Story_of_the_Tamamayu",
    .prepare_note =
