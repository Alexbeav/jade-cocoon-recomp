...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/jade-cocoon-recomp/total)](https://github.com/Alexbeav/jade-cocoon-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/jade-cocoon-recomp/latest/total)](https://github.com/Alexbeav/jade-cocoon-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/jade-cocoon-recomp)](https://github.com/Alexbeav/jade-cocoon-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Jade Cocoon: Story of the Tamamayu** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-00854 disc image
...
|---|---|
| Region | USA |
| Disc serial | SLUS-00854 |
| Discs | 1 |
| Supported dump | Redump `Jade Cocoon - Story of the Tamamayu (USA).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/jade-cocoon-recomp/releases)
   and extract it into a writable folder.
2. Start `Jade_Cocoon_Story_of_the_Tamamayu` (`.exe` on Windows).
...
named `diagnostic-mode.txt` next to `Jade_Cocoon_Story_of_the_Tamamayu.exe` and start the game as
usual, or run `Jade_Cocoon_Story_of_the_Tamamayu.exe --diagnostic`. Reproduce the problem, quit, then
run `Jade_Cocoon_Story_of_the_Tamamayu.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
