...
#
# Writes: dist/jadecocoon-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix jadecocoon \
  --exe-name Jade_Cocoon_Story_of_the_Tamamayu \
  --omit-openbios \
  --display-name "Jade Cocoon: Story of the Tamamayu" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Jade Cocoon: Story of the Tamamayu (USA) disc" \
  --runtime-dir mods \
